...
function game() {
    ...
    if (game5.ps === game5.cs) {
        return "It's a draw! Enough for now.";
    } else if (game5.ps > game5.cs) {
        return "You win! Computer is defeated."
    } else if (game5.ps < game5.cs) {
        return "You lose! The computer takes this one."
    }
}
let final = game();
